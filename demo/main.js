...
var TerrainView = (function() {
  ...
  function setupLights() {
    var ambientLight = new THREE.AmbientLight(0xfff, 0.9);
    scene.add(ambientLight);

    var mainLight = new THREE.SpotLight(0xfff, 1.0);
    mainLight.position.set(500, 500, 500);
    mainLight.castShadow = true;
    scene.add(mainLight);

    var auxLight = new THREE.SpotLight(0xfff, 1.0);
  ...
  function drawCoordinate(center, length) {
    var othorgonals = [
      [new THREE.Vector3(length, 0, 0), 0xfff],
      [new THREE.Vector3(0, length, 0), 0xfff],
      [new THREE.Vector3(0, 0, length), 0xfff]
    ];
